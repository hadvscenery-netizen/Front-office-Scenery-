...
(() => {
  ...
  style.textContent = [
    ...
    '#view-invoice .fallback-deposit-control{display:grid;grid-template-columns:124px;gap:5px;min-width:124px}',
    '#view-invoice .fallback-line-deposit-method{display:block;width:124px;min-width:124px;max-width:124px;height:36px;box-sizing:border-box;padding:5px 8px;border:1px solid #d8c8bc;border-radius:6px;background:#fffdfb;color:#3e342e;font:inherit;font-size:12px;line-height:22px}',
